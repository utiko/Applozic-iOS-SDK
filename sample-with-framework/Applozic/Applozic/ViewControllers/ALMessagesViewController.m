...
//            [TSMessage showNotificationInViewController:self title:@"No Internet" subtitle:@"" type:TSMessageNotificationTypeError];
            
            [TSMessage showNotificationInViewController:self title:@"" subtitle:@"No Internet" type:TSMessageNotificationTypeError duration:1.5 canBeDismissedByUser:NO];
