...
-(void)setUpTheming {
    ...
    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc] initWithTitle:[ALApplozicSettings getBackButtonTitle] style:UIBarButtonItemStyleBordered target:self action:@selector(back:)];
